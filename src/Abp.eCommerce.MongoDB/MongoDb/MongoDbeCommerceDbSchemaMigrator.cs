...
public class MongoDbeCommerceDbSchemaMigrator : IeCommerceDbSchemaMigrator, ITransientDependency
{
    private readonly IServiceProvider _serviceProvider;

    public MongoDbeCommerceDbSchemaMigrator(IServiceProvider serviceProvider)
    {
